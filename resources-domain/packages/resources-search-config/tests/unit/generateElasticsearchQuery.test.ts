...
import {
  type SearchGenerateElasticsearchQueryParams,
...
describe('Search', () => {
  describe('generateElasticsearchQuery', () => {
    type TestCaseParameters = {
      config: ResourcesSearchConfiguration;
      parameters: SearchGenerateElasticsearchQueryParams;
      condition: string;
      expectationDescription: string;
      expectedResults: SearchQuery;
    };
    ...
    each(testCases).test(
      ...
      ({
        ...
        expect(generateElasticsearchQuery(config)(parameters)).toEqual(expectedResults);
      },
    );
  });
});
