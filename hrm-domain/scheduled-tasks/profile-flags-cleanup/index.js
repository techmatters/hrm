...
exports.cleanupProfileFlags = void 0;
/**
...
const profileApi = __importStar(require("./dataAccess"));
const cleanupProfileFlags = async () => {
    try {
        ...
        if ((0, types_1.isErr)(result)) {
            console.error(`[scheduled-task:profile-flags-cleanup]: Error during cleanup: ${result.error}, ${result.message}`);
            return;
        }
        console.info(`[scheduled-task:profile-flags-cleanup]: Removed ${result.data.count} profiles-to-profile-flags associations`);
    }
    catch (err) {
