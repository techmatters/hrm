...
import { processDiariazationJobsGPU } from '../../core';

export const command = 'diarization-jobs-gpu';
export const describe =
  'Run concurrent diarization jobs against the pyannote service using GPU';
