...
exports.describe = 'Edit an existing profile flag';
exports.builder = {
    e: {
        alias: 'environment',
...
const handler = async ({ region, environment, accountSid, flagId, name }) => {
    try {
        ...
        console.error(`Failed to edit profile flag ${flagId} for account ${accountSid} (${region} ${environment})`, err instanceof Error ? err.message : String(err));
    }
};
