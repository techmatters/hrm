...
exports.describe = 'Create a new profile flag';
exports.builder = {
    e: {
        alias: 'environment',
...
const handler = async ({ region, environment, accountSid, name }) => {
    try {
        ...
        console.error(`Failed to create flag ${name} account ${accountSid} (${region} ${environment})`, err instanceof Error ? err.message : String(err));
    }
};
